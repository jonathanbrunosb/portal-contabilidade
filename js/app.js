import { loadData,isLiveDataSource,apiWrite,apiUploadPhoto,getAdminToken,setAdminToken,hasLocalTeams,saveLocalTeams,clearLocalTeams,hasLocalAutomacoes,saveLocalAutomacoes,clearLocalAutomacoes } from './data-service.js?v=20260921-47';
import { identifyUser,renderUser,hasAccess,getStoredUserId,setStoredUserId } from './auth.js?v=20260921-47';
import { initializeNavigation,markCurrentSection,bindTabs,selectTab } from './navigation.js?v=20260921-47';
import { comunicados,filtrarComunicados,faixaComunicado,paginaComunicado,colunasOrigem,itemDaColuna,hashComunicado,ligarMidias,ultimaAtualizacaoLabel } from './newsletter.js?v=20260921-47';
import { renderTeamStructure } from './teams.js?v=20260921-47';
import { initCarousel,slideHTML } from './carousel.js?v=20260921-47';
import { TIPOS_ALVO,SITUACOES,LIMITE_NO_AR,situacaoDestaque,alvoDoDestaque,resolverDestaque,destaquesNoAr,destaqueDoAlvo } from './destaques.js?v=20260921-47';
import { escapeHTML as e,normalize,icon,hydrateIcons,badge,dateLabel,showDialog,initializeDialog,detailGrid,safeURL,comVersao,notify,ORIGENS,seloOrigem,opcoesOrigem } from './ui.js?v=20260921-47';
import { track,setAnalyticsEnabled,summary,exportAnalytics,clearAnalytics } from './analytics.js?v=20260921-47';
