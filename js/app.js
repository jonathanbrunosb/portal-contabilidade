import { loadData,isLiveDataSource,apiWrite,apiUploadPhoto,getAdminToken,setAdminToken,hasLocalTeams,saveLocalTeams,clearLocalTeams,hasLocalAutomacoes,saveLocalAutomacoes,clearLocalAutomacoes } from './data-service.js?v=20260922-3';
import { identifyUser,renderUser,hasAccess,getStoredUserId,setStoredUserId } from './auth.js?v=20260922-3';
import { initializeNavigation,markCurrentSection,bindTabs,selectTab } from './navigation.js?v=20260922-3';
import { comunicados,filtrarComunicados,faixaComunicado,paginaComunicado,colunasOrigem,itemDaColuna,hashComunicado,ligarMidias,ultimaAtualizacaoLabel,textoDoComunicado } from './newsletter.js?v=20260922-3';
import { prepararIndice,agrupar,destacar,termosDe,atributosDoLink,ligarBuscaTopo,MINIMO_CARACTERES } from './busca.js?v=20260922-3';
import { renderTeamStructure } from './teams.js?v=20260922-3';
import { initCarousel,slideHTML } from './carousel.js?v=20260922-3';
import { TIPOS_ALVO,SITUACOES,LIMITE_NO_AR,situacaoDestaque,alvoDoDestaque,resolverDestaque,destaquesNoAr,destaqueDoAlvo } from './destaques.js?v=20260922-3';
import { escapeHTML as e,normalize,icon,hydrateIcons,badge,dateLabel,showDialog,initializeDialog,detailGrid,safeURL,comVersao,notify,ORIGENS,seloOrigem,opcoesOrigem } from './ui.js?v=20260922-3';
import { track,setAnalyticsEnabled,summary,exportAnalytics,clearAnalytics } from './analytics.js?v=20260922-3';
