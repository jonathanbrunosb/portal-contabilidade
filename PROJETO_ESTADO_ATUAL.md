...
> **Git:** branch `ajustes-frontend-dudu`, **19 commits à frente de `6b6273c`**, um por assunto (seção 2); depois do checkpoint ("Documentar o dia 21/09 e adotar commit por assunto") vieram o dos comunicados tirados dos e-mails (IFRS 16 e Movimentação da Controladoria) e o da capa da Movimentação com as fotos. **Nada enviado** (`git push` só quando o usuário pedir). `main` não recebeu nada.
...
> **Working tree:** limpo depois do commit do checkpoint. Cache-buster: `?v=20260921-49`.
...
2. **Enviar a branch** (`git push`) quando o usuário pedir — 19 commits locais.
